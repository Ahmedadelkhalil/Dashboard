...
const CardBottom = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="https://www.facebook.com/share/1C35dQpMHx/" target="_blank">
          <FacebookIcon
            fontSize="small"
            sx={{
              color: theme.palette.text.secondary,
        ...
        <Link
          href="https://www.linkedin.com/in/ahmed-adel-khalil/"
          target="_blank"
        >
          <LinkedInIcon
            fontSize="small"
        ...
        <Link href="https://wa.me/+201025521486/" target="_blank">
          <WhatsAppIcon
            fontSize="small"
            sx={{
              color: theme.palette.text.secondary,
